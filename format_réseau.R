...
setwd("C://Users//USER//Desktop//Laurencia//ABGD")


csv <- read.csv("abgd_inital_partition.txt", header = T, 
                sep = ",", encoding = "latin1")



#ON extrait à partir de la 1ère colonne l'identifiant (voucher), 
# les noms de genre et d'espèce et la région
